...
class DeepSeekEngine:
    ...
    def infer(
        ...
        Note:
            The official infer() method expects image_file as a STRING path, not PIL Image.
            We save the PIL Image to a temporary file and pass the path.
            ...
            3. Calls load_pil_images() to load images from file paths
